...
const image1 = require('../Cart/imagecart/11.jpg');
const image2 = require('../Cart/imagecart/22.jpg');
const image3 = require('../Cart/imagecart/33.jpg');
const image4 = require('../Cart/imagecart/44.jpg');
const image5 = require('../Cart/imagecart/55.jpg');

const data = [
{
  id: 1,
  image: image1,
  name: 'ข้าวกะเพราะหมูสับ',
  price: 30,
  amountTaken: 0
}, {
  id: 2,
